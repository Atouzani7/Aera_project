      ...
      <main className="pt-24">
        ...
        >
          ...
          <div className="flex flex-col md:items-center justify-center ">
            ...
            <p className=" p-4 text-3xl "><br /> Des projets clairs. Des clients ravis. <br /></p>
        ...
        <motion.div
          ...
          <p className="text-3xl text-center m-8 ">Pour qui ?</p>
          ...
          <motion.div
            ...
            >
              <motion.div className="flex flex-col items-center justify-center p-4 bg-background text-center md:text-left "
                variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.6 }}
              >
                <Image
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="  md:flex-row items-center justify-center p-4 bg-background text-center md:text-left ">
            ...
            <motion.div>
              <motion.form className="flex flex-col gap-4  items-center justify-center mt-4">
                <input
                  ...
                  className="border border-border bg-input m-auto px-4 py-2 rounded-md mr-4 focus:outline-none focus:ring-2 focus:ring-detail-pink transition mb-4 md:mb-0"
                />

                <button className=" mb-8 border border-border bg-button px-6 py-3 rounded-md hover:bg-button-hover hover:text-foreground transition">
                  Commencer maintenant
                </button>
              </motion.form>
              <p className="text-sm text-foreground">Aucun engagement. Pas de frais.</p>
            </motion.div>
